<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'FAMVILLE | INQUIRY ACCEPTANCE : '.strtoupper($inquiryEmail).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>FAMVILLE | INQUIRY ACCEPTANCE </title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <p><h3 style="text-align:center;"><b>SUBJECT : '.$inquirySubject.'</b></h3></p>
                            <p><h3 style="text-align:center;"><b>MESSAGE : '.$inquiryMessage.'</b></h3></p>
                          </td>
                        </tr>
                      </table>
                    </td>
