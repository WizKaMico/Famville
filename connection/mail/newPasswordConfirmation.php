<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'FAMVILLE | ACCOUNT RECOVERY CONFIRMATION W/PASSWORD : '.strtoupper($emailExist).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>FAMVILLE | ACCOUNT RECOVERY CONFIRMATION W/PASSWORD </title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <p><h3 style="text-align:center;"><b>NEW ACCOUNT PASSWORD : '.$newPassword.'</b></h3></p>
                          </td>
                        </tr>
                      </table>
                    </td>
