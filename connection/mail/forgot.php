<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'FAMVILLE | ACCOUNT RECOVERY : '.strtoupper($emailAccount).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>FAMVILLE | ACCOUNT RECOVERY </title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <p><h3 style="text-align:center;"><b>6-DIGIT CODE : '.$codeAccount.'</b></h3></p>
                          </td>
                        </tr>
                      </table>
                    </td>
